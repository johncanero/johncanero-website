    ...
    <div className="mt-4">
      <div>
        ...
        <div className="flex flex-wrap justify-center md:mx-20  lg:mx-72 font-Poppins">
          ...
          {/* CSS */}
          <div className="flex justify-center bg-gray-200 dark:bg-gray-900 rounded-2xl mr-3 w-36  mt-4 transition ease-in-out  hover:-translate-y-1 hover:scale-105 duration-300">
            <div className="w-12">
              <Image
          ...
          {/* Visual Studio Code */}
          <div className="flex justify-center bg-gray-200 dark:bg-gray-900 rounded-2xl w-56  mr-3 mt-4 transition ease-in-out  hover:-translate-y-1 hover:scale-105 duration-300">
            <div className="w-12">
              <Image
        ...
        <div className="font-Poppins">
          <p className="text-center mt-6 mx-auto w-80 md:mt-10 md:w-5/12">
            These are the Tech Stack Tools the I use as a developer in
        ...
        <div className="flex flex-wrap justify-center md:mx-20 lg:mx-72 font-Poppins mb-8">
          ...
          <div className="font-Poppins">
            <p className="text-center mt-6 mx-auto w-80 md:mt-10 md:w-10/12">
              These are the the Tech Stack Design Tools I used in designing
