      ...
      <div className="w-full h-screen bg-blue-50">
        <div className="px-3 mt-6">
            <form className="flex flex-col items-center w-1/3 mx-auto">
              ...
              <button className="w-full py-2 mt-6 text-lg text-white bg-purple-500 rounded-md outline-none active:bg-purple-600 focus:ring-2 focus:ring-purple-400 disabled:bg-opacity-50 disabled:cursor-not-allowed" type="submit" 
