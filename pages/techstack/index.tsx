...
const techstack = () => {
  return (
    <div className="justify-center mb-20 lg:mr-14">
      <div className="mt-4">
        ...
        <div className="flex flex-wrap justify-center font-Poppins lg:mx-48">
          ...
          {/* Bootstrap */}
          <div className="flex justify-center mt-4 mr-3 transition duration-300 ease-in-out bg-gray-50 dark:bg-gray-900 rounded-2xl w-36 hover:-translate-y-1 hover:scale-105 animate__animated animate__fadeInanimate__animated animate__fadeIn">
            <div className="w-12">
              <Image
          ...
          {/* Visual Studio Code */}
          <div className="flex justify-center w-56 mt-4 mr-3 transition duration-300 ease-in-out bg-gray-50 dark:bg-gray-900 rounded-2xl hover:-translate-y-1 hover:scale-105 animate__animated animate__fadeIn">
            <div className="w-12">
              <Image
