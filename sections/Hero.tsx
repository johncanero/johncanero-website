...
const Hero = () => {
  return (
    <section className="mt-16 font-Poppins lg:mr-60">
      ...
      <h3 className="flex text-center my-3 mt-3 mb-5 text-xl mx-4 md:mx-0 md:mt-2 md:mb-3 md:text-left md:justify-start md:text-3xl lg:mr-48">
        I am Frontend Engineer, Web Developer & Architectural Designer
      </h3>
      <p className="flex mb-10 mx-6 md:mb-8 md:mx-0 sm:text-center md:text-left text-gray-600 md:mr-48 lg:mr-96">
