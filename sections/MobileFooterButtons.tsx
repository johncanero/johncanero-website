...
const MobileFooterButtons = () => {
  return (
    <div>
      <div className="fixed bottom-0 left-0 flex justify-center w-screen py-3 text-center bg-gray-100 border dark:bg-black gap-11 border-t-1 border-slate-400 dark:border-slate-700 border-x-0 md:hidden ">
        {/* Home */}
